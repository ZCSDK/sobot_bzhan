...
public class OrderCardMessageHolder extends MessageHolderBase implements View.OnClickListener {
    ...
    private SobotOrderCardContentModel orderCardContent;
    ...
    public void bindData(final Context context, final ZhiChiMessageBase message) {
        ...
        if (orderCardContent != null) {
            if (orderCardContent.getGoods() != null && orderCardContent.getGoods().size() > 0) {
                ...
                SobotOrderCardContentModel.Goods firstGoods = orderCardContent.getGoods().get(0);
            ...
            if (orderCardContent.getOrderStatus() > 0) {
                ...
                mOrderStatus.setText(Html.fromHtml(ResourceUtils.getResString(context, "sobot_order_status_lable") + statusStr + "</b>"));
            } else {

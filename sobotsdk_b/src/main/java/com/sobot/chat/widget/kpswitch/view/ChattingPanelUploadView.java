...
public class ChattingPanelUploadView extends BaseChattingPanelView implements View.OnClickListener, EmoticonsFuncView.OnEmoticonsPageViewListener {
    ...
    private static final String ACTION_MY_LEAVEMSG = "sobot_action_my_leavemsg";
    ...
    public void initData() {
        ...
        //我的留言
        SobotPlusEntity myLeavemsgEntity = new SobotPlusEntity(getResDrawableId("sobot_leavemsg_selector"), getResString("sobot_str_bottom_my_message"), ACTION_MY_LEAVEMSG);
        //图片
        ...
        if (leaveMsg == ZhiChiConstant.sobot_msg_flag_open) {
            ...
            robotList.add(myLeavemsgEntity);
        }
        ...
        if (leaveMsg == ZhiChiConstant.sobot_msg_flag_open) {
            ...
            operatorList.add(myLeavemsgEntity);
        }
...
//                                adapter.setItemHeightMaxRatio(1.8);
    ...
    public interface SobotPlusClickListener extends SobotBasePanelListener {
        ...
        void startToMYPostMsgActivty(boolean flag);
    ...
    public void onClick(View v) {
        if (mListener != null) {
            ...
            } else if (ACTION_MY_LEAVEMSG.equals(action)) {
                //我的留言
                mListener.startToMYPostMsgActivty(false);

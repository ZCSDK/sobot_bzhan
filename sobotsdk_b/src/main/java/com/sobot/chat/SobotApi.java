...
//			e.printStackTrace();
	 ...
	 * @param content 卡片信息
	 */
	public static void sendOrderCardMsg(Context context, SobotOrderCardContentModel content) {
		if (context == null || content == null) {
			return;
		}
	 ...
	 * @param initListener
	 */
	public static void setSobotInitErrorListener(SobotInitErrorListener initListener){
		SobotOption.sobotInitErrorListener = initListener;
	}
}